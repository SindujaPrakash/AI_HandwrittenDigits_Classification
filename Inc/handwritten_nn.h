...
#ifndef __AI_HANDWRITTEN_NN_H__
#define __AI_HANDWRITTEN_NN_H__
#pragma once

#include "ai_platform.h"

#define AI_HANDWRITTEN_NN_MODEL_NAME          "handwritten_nn"

#define AI_HANDWRITTEN_NN_IN_NUM       (1)
#define AI_HANDWRITTEN_NN_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 28, 1, 28, 1, NULL), \
}
#define AI_HANDWRITTEN_NN_IN_SIZE { \
  (28 * 1 * 28), \
}
#define AI_HANDWRITTEN_NN_IN_1_SIZE  (28 * 1 * 28)
#define AI_HANDWRITTEN_NN_IN_1_SIZE_BYTES  ((28 * 1 * 28) * 4)


#define AI_HANDWRITTEN_NN_OUT_NUM      (1)
#define AI_HANDWRITTEN_NN_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 10, 1, NULL), \
}
#define AI_HANDWRITTEN_NN_OUT_SIZE { \
  (1 * 1 * 10), \
}
#define AI_HANDWRITTEN_NN_OUT_1_SIZE  (1 * 1 * 10)
#define AI_HANDWRITTEN_NN_OUT_1_SIZE_BYTES  ((1 * 1 * 10) * 4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup handwritten_nn
 ...
 */
AI_API_ENTRY
ai_bool ai_handwritten_nn_get_info(
 ...
 * @ref ai_handwritten_nn_create. Both the activations memory buffer 
 ...
 * using @ref ai_handwritten_nn_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_HANDWRITTEN_NN_*
 * defines into file @ref handwritten_nn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_handwritten_nn_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_HANDWRITTEN_NN_H__*/
