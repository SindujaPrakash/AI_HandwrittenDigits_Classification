...
#define AI_NET_OBJ_INSTANCE g_digitclassification
 
#undef AI_DIGITCLASSIFICATION_MODEL_SIGNATURE
#define AI_DIGITCLASSIFICATION_MODEL_SIGNATURE     "b7718a35388424d7f64e4e27371b57af"
...
#define AI_TOOLS_DATE_TIME   "Wed Oct 30 15:23:34 2019"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_DIGITCLASSIFICATION_N_BATCHES
#define AI_DIGITCLASSIFICATION_N_BATCHES         (1)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 552, 1,
                     NULL),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_DIGITCLASSIFICATION_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_DIGITCLASSIFICATION_OUT_NUM, &dense_2_nl_output),
  &dense_1_layer, 0)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_DIGITCLASSIFICATION_MODEL_NAME,
      .model_signature   = AI_DIGITCLASSIFICATION_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_i32 ai_digitclassification_forward(ai_handle network, const ai_buffer* input)
{
