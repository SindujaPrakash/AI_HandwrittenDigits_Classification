...
#define AI_NET_OBJ_INSTANCE g_handwritten_nn
 
#undef AI_HANDWRITTEN_NN_MODEL_SIGNATURE
#define AI_HANDWRITTEN_NN_MODEL_SIGNATURE     "f7e08a8ca31de8ace403d4470fbfa672"
...
#define AI_TOOLS_DATE_TIME   "Wed Oct 30 10:17:26 2019"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_HANDWRITTEN_NN_N_BATCHES
#define AI_HANDWRITTEN_NN_N_BATCHES         (1)
...
AI_STATIC ai_array dense_output_array;   /* Array #8 */
AI_STATIC ai_array dense_nl_output_array;   /* Array #9 */
AI_STATIC ai_array dense_1_output_array;   /* Array #10 */
AI_STATIC ai_array dense_1_nl_output_array;   /* Array #11 */
AI_STATIC ai_array dense_2_output_array;   /* Array #12 */
AI_STATIC ai_array dense_2_nl_output_array;   /* Array #13 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  AI_STRIDE_INIT(802816, 802816, 3136, 4),
  &dense_weights_array,
  AI_STATIC)
AI_TENSOR_OBJ_DECLARE(
  input_0_output,
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 1536, 1,
                     NULL),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_HANDWRITTEN_NN_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_HANDWRITTEN_NN_OUT_NUM, &dense_2_nl_output),
  &dense_layer, 0)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_HANDWRITTEN_NN_MODEL_NAME,
      .model_signature   = AI_HANDWRITTEN_NN_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_i32 ai_handwritten_nn_forward(ai_handle network, const ai_buffer* input)
{
